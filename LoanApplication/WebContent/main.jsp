...
%>
	...
	<div style="padding-left:30px;background-color:#add8e6;">
		...
		<div class="tab-pane ${act_datewise}" id="n">
			<h3>Date Wise</h3>
			<input type="date" id="date" name="adate" value="" min="2010-01-01"
				max="2020-12-31">
			<input class="btn" type="submit" value="Go" name="abutton1">
			
		</div>
		<div class="tab-pane ${act_month}" id="w" style="background-color:#add8e6;padding-left:20x;">
			<h3>Month Wise</h3>
			<input type="month" id="month" name="amonth" min="2010-01"
					value="2020-01">
				 <input class="btn" type="submit" value="Go" name="abutton2">

		</div>
	    <div class="tab-pane ${act_daterange}" id="x" style="background-color:#add8e6;padding-left:20x;">
			<h2>Start Date:</h2>
			<input type="date" id="sdate" name="astart" value="" min="2010-01-01"
				max="2020-12-31">
			<h2>End Date:</h2>
			<input type="date" id="edate" name="aend" value="" min="2010-01-01"
				max="2020-12-31">
			<input class="btn" type="submit" value="Go" name="abutton3">
		</div>
